...
class DeceptiveNodeSchema:
    ...
    MAX_NUMBER: Final[YawningTitanQuery] = (
        YawningTitanQuery().blue.action_set.deceptive_nodes.max_number
    )
    NEW_NODE_ON_RELOCATE: Final[YawningTitanQuery] = (
...
class OnScanSchema:
    ...
    STANDARD_NODE: Final[YawningTitanQuery] = (
        YawningTitanQuery().blue.intrusion_discovery_chance.on_scan.standard_node
    )
    DECEPTIVE_NODE: Final[YawningTitanQuery] = (
...
class BlueAttackDiscoverySchema:
    ...
    SUCCEEDED_ATTACKS_KNOWN_COMPROMISE: Final[SucceededAttackKnownCompromiseSchema] = (
...
class ZeroDaySchema:
    ...
    START_AMOUNT: Final[YawningTitanQuery] = (
        YawningTitanQuery().red.action_set.zero_day.start_amount
    )
    DAYS_REQUIRED: Final[YawningTitanQuery] = (
...
class AttackSourceSchema:
    ...
    ONLY_MAIN_RED_NODE: Final[YawningTitanQuery] = (
        YawningTitanQuery().red.agent_attack.attack_from.only_main_red_node
    )
    ANY_RED_NODE: Final[YawningTitanQuery] = (
...
class NaturalSpreadChanceSchema:
    ...
    TO_CONNECTED_NODE: Final[YawningTitanQuery] = (
        YawningTitanQuery().red.natural_spreading.chance.to_connected_node
    )
    TO_UNCONNECTED_NODE: Final[YawningTitanQuery] = (
...
class TargetNodeSchema:
    ...
    TARGET: Final[YawningTitanQuery] = (
        YawningTitanQuery().red.target_mechanism.target_specific_node.target
    )
    ALWAYS_CHOOSE_SHORTEST_DISTANCE: Final[YawningTitanQuery] = (
...
class SpreadSchema:
    ...
    LIKELIHOOD: Final[YawningTitanQuery] = (
...
class RandomInfectSchema:
    ...
    CHANCE: Final[YawningTitanQuery] = (
...
class RedAgentAttackSchema:
    ...
    IGNORES_DEFENCES: Final[YawningTitanQuery] = (
        YawningTitanQuery().red.agent_attack.ignores_defences
    )
    ALWAYS_SUCCEEDS: Final[YawningTitanQuery] = (
...
class RedNaturalSpreadingSchema:
    ...
    CAPABLE: Final[YawningTitanQuery] = (
...
class RedTargetMechanismSchema:
    ...
    PRIORITISE_CONNECTED_NODES: Final[YawningTitanQuery] = (
        YawningTitanQuery().red.target_mechanism.prioritise_connected_nodes
    )
    PRIORITISE_UNCONNECTED_NODES: Final[YawningTitanQuery] = (
        YawningTitanQuery().red.target_mechanism.prioritise_unconnected_nodes
    )
    PRIORITISE_VULNERABLE_NODES: Final[YawningTitanQuery] = (
        YawningTitanQuery().red.target_mechanism.prioritise_vulnerable_nodes
    )
    PRIORITISE_RESILIENT_NODES: Final[YawningTitanQuery] = (
...
class ResetSchema:
    ...
    RANDOMISE_VULNERABILITIES: Final[YawningTitanQuery] = (
        YawningTitanQuery().on_reset.randomise_vulnerabilities
    )
    CHOOSE_NEW_HIGH_VALUE_NODES: Final[YawningTitanQuery] = (
        YawningTitanQuery().on_reset.choose_new_high_value_nodes
    )
    CHOOSE_NEW_ENTRY_NODES: Final[YawningTitanQuery] = (
...
class RewardsSchema:
    ...
    FOR_REACHING_MAX_STEPS: Final[YawningTitanQuery] = (
        YawningTitanQuery().reward.for_reaching_max_steps
    )
    END_REWARDS_ARE_MULTIPLIED_BY_END_STATE: Final[YawningTitanQuery] = (
        YawningTitanQuery().reward.end_rewards_are_multiplied_by_end_state
    )
    REDUCE_NEGATIVE_REWARDS_FOR_CLOSER_FAILS: Final[YawningTitanQuery] = (
...
class MiscellaneousSchema:
    ...
    OUTPUT_TIMESTEP_DATA_TO_JSON: Final[YawningTitanQuery] = (
...
class GameRulesSchema:
    ...
    GRACE_PERIOD_LENGTH: Final[YawningTitanQuery] = (
